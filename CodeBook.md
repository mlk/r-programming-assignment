...
By default `run_analysis.R` will create a file `./data/results.txt`, however this can be changed via the `destination_file` variable. It can be read by R using the `read.table` fuction.
